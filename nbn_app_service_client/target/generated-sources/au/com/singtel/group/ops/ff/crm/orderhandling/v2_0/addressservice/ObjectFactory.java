...
public class ObjectFactory {
    ...
    private final static QName _QueryAddressByIdResponseAddress_QNAME = new QName("http://www.group.singtel.com.au/ops/ff/crm/orderhandling/v2_0/AddressService", "address");
    private final static QName _QueryAddressByIdResponseStatus_QNAME = new QName("http://www.group.singtel.com.au/ops/ff/crm/orderhandling/v2_0/AddressService", "status");
    ...
    public JAXBElement<AustralianPropertyAddress> createQueryAddressByIdResponseAddress(AustralianPropertyAddress value) {
        return new JAXBElement<AustralianPropertyAddress>(_QueryAddressByIdResponseAddress_QNAME, AustralianPropertyAddress.class, QueryAddressByIdResponse.class, value);
    }
    ...
    public JAXBElement<String> createQueryAddressByIdResponseStatus(String value) {
        return new JAXBElement<String>(_QueryAddressByIdResponseStatus_QNAME, String.class, QueryAddressByIdResponse.class, value);
    }
    ...
    public JAXBElement<String> createQueryAddressNotificationResponseStatus(String value) {
        return new JAXBElement<String>(_QueryAddressByIdResponseStatus_QNAME, String.class, QueryAddressNotificationResponse.class, value);
    }
    ...
    public JAXBElement<AustralianPropertyAddress> createQueryAddressResponseAddress(AustralianPropertyAddress value) {
        return new JAXBElement<AustralianPropertyAddress>(_QueryAddressByIdResponseAddress_QNAME, AustralianPropertyAddress.class, QueryAddressResponse.class, value);
    }
    ...
    public JAXBElement<String> createQueryAddressResponseStatus(String value) {
        return new JAXBElement<String>(_QueryAddressByIdResponseStatus_QNAME, String.class, QueryAddressResponse.class, value);
    }
