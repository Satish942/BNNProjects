package au.com.optus.mcas.sdp.nbnenabler.service.dao.impl;
...
import au.com.optus.mcas.sdp.nbnenabler.service.dao.NbnEnablerServiceDAOIF;
import au.com.optus.mcas.sdp.nbnenabler.service.util.NbnEnablerServiceConstants;
 ...
 *
 */
public class NbnServiceDAOImpl implements NbnEnablerServiceDAOIF{

	private static final Logger logger = LoggerFactory.getLogger(NbnServiceDAOImpl.class);
	...
	public NBNNotification getNotificationById(String transactionId) {
		...
		Query query = session.createQuery(NbnEnablerServiceConstants.GET_NOTIFICATION_BY_ID_SQL);
	...
	public NBNCorrelation getCorrelationById(String transactionId,
		...
		Session session = getSessionFactory().openSession();
		Query query = session.createQuery(NbnEnablerServiceConstants.GET_CORRELATION_BY_ID_SQL);
        query.setString(1,transactionId);
